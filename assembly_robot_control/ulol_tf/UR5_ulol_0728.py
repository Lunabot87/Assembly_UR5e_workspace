...
class UR5(object):
  ...
  def go_to_pose_goal(self,pose_goal,offset = 0):
  ...
  def get_target_orientation(self,orientation,xyz_length = [0,0,0]):
    w = orientation.w
    x = orientation.x
    y = orientation.y
    z = orientation.z
  ...
  def grab_part(self, target_pose, target_size, offset):
