...
P2hole1={'trans':[0.17,0.01222,0.01],'rot':[0,-pi/2,0]}
P2hole2={'trans':[0.17,-0.0122,0.01],'rot':[0,-pi/2,0]}
P2hole3={'trans':[-0.17,0.0122,0.01],'rot':[0,-pi/2,pi]}
P2hole4={'trans':[-0.17,-0.0122,0.01],'rot':[0,-pi/2,pi]}
P2hole5={'trans':[0.10952,-0.0145,0.02],'rot':[pi,0,pi]}
P2hole6={'trans':[-0.10952,-0.0145,0.02],'rot':[pi,0,pi]}
...
P3hole1={'trans':[ 0.135, 0.0165, 0.01],'rot':[pi,pi/2,0]}
P3hole2={'trans':[ 0.135,-0.0165, 0.01],'rot':[pi,pi/2,0]}
P3hole3={'trans':[-0.135, 0.0165, 0.01],'rot':[0,pi/2,0]}
P3hole4={'trans':[-0.135,-0.0165, 0.01],'rot':[0,pi/2,0]}
P3hole5={'trans':[ 0.080,-0.013, 0.02],'rot':[pi,0,pi]}
P3hole6={'trans':[-0.080,-0.013, 0.02],'rot':[pi,0,pi]}
P3hole7={'trans':[-0.135,-0.0000, 0.01],'rot':[0,pi/2,0]}
P3hole8={'trans':[ 0.135,-0.0000, 0.01],'rot':[0,-pi/2,0]}

P3hole_offset=[P3hole1,P3hole2,P3hole3,P3hole4,
				P3hole5,P3hole6,P3hole7,P3hole8]

P4hole1={'trans':[ 0.135, 0.0165, 0.007],'rot':[-pi/2,pi/2,pi/2]}
P4hole2={'trans':[ 0.135,-0.0165, 0.007],'rot':[-pi/2,pi/2,pi/2]}
P4hole3={'trans':[-0.135, 0.0165, 0.007],'rot':[0,pi/2,0]}
P4hole4={'trans':[-0.135,-0.0165, 0.007],'rot':[pi,-pi/2,0]}
P4hole5={'trans':[-0.135,-0.294, 0.007],'rot':[0,pi/2,0]}
P4hole6={'trans':[ 0.135,-0.294, 0.007],'rot':[-pi/2,pi/2,pi/2]}
P4hole7={'trans':[-0.135, 0.000, 0.007],'rot':[0,pi/2,0]}
P4hole8={'trans':[ 0.135, 0.000, 0.007],'rot':[-pi/2,pi/2,pi/2]}
...
P6hole3={'trans':[0.370, 0.41203,-0.050],'rot':[3.1415,0,0]}
P6hole4={'trans':[0.370, 0.37903,-0.050],'rot':[3.1415,0,0]}
