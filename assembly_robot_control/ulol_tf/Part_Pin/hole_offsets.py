...
P5hole1={'trans':[0.002166, 0.426660, 0.005],'rot':[0,pi,0]}
P5hole2={'trans':[0.000492, 0.394704, 0.005],'rot':[0,pi,0]}
P5hole3={'trans':[0.369042, 0.407433, 0.040],'rot':[0,pi,0]}
P5hole4={'trans':[0.367368, 0.375477, 0.040],'rot':[0,pi,0]}
P5hole5={'trans':[0.393244, 0.567391, 0.035],'rot':[0,pi,0]}
P5hole6={'trans':[0.427122, 0.844371, 0.035],'rot':[0,pi,0]}
P5hole7={'trans':[0.431575, 0.876060, 0.035],'rot':[0,pi,0]}
P5hole8={'trans':[0.001329, 0.410682,-0.015],'rot':[0,0,0]}
P5hole9={'trans':[0.369205, 0.391455, 0.020],'rot':[0,0,0]}
P5hole10={'trans':[0.429349, 0.860216, 0.020],'rot':[0,0,0]}
