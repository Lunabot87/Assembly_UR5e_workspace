...
part_spare_pose = [part1_pose,part2_pose,part3_pose,part4_pose,part5_pose,part6_pose]

for i in range(6):
	part_spare_pose[i].header.frame_id = "world"
	part_spare_pose[i].pose.orientation.w = 1.0
	part_spare_pose[i].pose.position.z = 0.83
...
orientation_list = quaternion_from_euler(0,0,0)
...
part6_pose.pose.position.x = -0.5
part6_pose.pose.position.y = -0.3
