...
part12_assembling_pose = [part1_pose,part2_pose,part3_pose,part4_pose,part5_pose,part6_pose]

for i in range(6):
	part12_assembling_pose[i].header.frame_id = "world"
	part12_assembling_pose[i].pose.orientation.w = 1.0
	part12_assembling_pose[i].pose.position.z = 0.83
...
part6_pose.pose.position.x = -0.35
