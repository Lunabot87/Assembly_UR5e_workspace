...
chair_part2_offset = {'trans':[-0.009,0.016,-0.1710],'rot':[0, pi/2, 0]}	# hole6-2
chair_part3_offset = {'trans':[ 0.009,0.016,-0.1260],'rot':[0, pi/2,pi]}			# hole6-4
chair_part4_offset = {'trans':[ 0.009,0.016,-0.1251],'rot':[0,-pi/2, 0]}			# hole6-6
chair_part5_offset = {'trans':[	0,000,-0.37, 0],'rot':[0,-0.09, 0]}
