...
from Assembly_Motion_com import Assembly_motion
from tf2_ros import *
import tf
...
class Assembly_process():
	...
	def fine_tune_insert_target(self, pa_part, hole_name, robot, move = True):
		...
		if move is True:
			...
			if hole_name not in ['part2_1-hole_7', 'part2_1-hole_8', 'part3_1-hole_7', 'part3_1-hole_8']:
